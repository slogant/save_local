 ...
 * @author slogant
 */
public class LimitadorTextoNumero extends PlainDocument {

    public LimitadorTextoNumero(JTextField mijtext, int nroMaxCaract) {
    ...
    private static final long serialVersionUID = 1016258660184805214L;
