 ...
 * @author slogant
 */
public class LimitadorTextoAlfabetico extends PlainDocument {

    public LimitadorTextoAlfabetico(JTextField mijtext, int nroMaxCaract) {
    ...
    public void insertString(int arg0, String arg1, AttributeSet arg2) throws BadLocationException {
        ...
        for (int i = 0; i < arg1.length(); i++) {
            if ((miJTextField.getText().length() + arg1.length()) > nroMaxCaracteres) {
                ...
                if (!Character.isSpaceChar(arg1.charAt(i))) {
                    return;
                }
            }
        }
    ...
    private static final long serialVersionUID = 1016258660184806214L;
