 ...
 * class construction.
 */
final public class TextPrompt extends JLabel implements FocusListener, DocumentListener {
...
//		setBorder(new EmptyBorder(component.getInsets()));
    ...
    public void changeAlpha(int alpha) {
        ...
        var red = foreground.getRed();
        var green = foreground.getGreen();
        var blue = foreground.getBlue();

        var withAlpha = new Color(red, green, blue, alpha);
