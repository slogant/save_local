 ...
 * @author noname
 */
public class LimitandorTextoMayusculas_1 extends PlainDocument {

    public LimitandorTextoMayusculas_1(JTextField mijtext, int nroMaxCaract, boolean mayusculas) {
